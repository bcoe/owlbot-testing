...
# [Beep boop API: Node.js Client](https://github.com/googleapis/nodejs-secret-manager)
...
* [Beep boop API Node.js Client API Reference][client-docs]
* [Beep boop API Documentation][product-docs]
...
1.  [Enable the Beep boop API API][enable_api].
...
The [Beep boop API Node.js Client API Reference][client-docs] documentation
