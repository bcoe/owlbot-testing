...
# [Beep Boop Bot the Second: Node.js Client](https://github.com/googleapis/nodejs-secret-manager)
...
* [Beep Boop Bot the Second Node.js Client API Reference][client-docs]
* [Beep Boop Bot the Second Documentation][product-docs]
...
1.  [Enable the Beep Boop Bot the Second API][enable_api].
...
The [Beep Boop Bot the Second Node.js Client API Reference][client-docs] documentation
